...
if(current_user_can('manage_options')){
    ...
    $attributesList[] = array("text" => "Posts", "children" => $this->utils->getPostAttributesForResult($search));
    $attributesList[] = array("text" => "WooCommerce", "children" => $this->utils->getWoocommerceAttributesForResults($search));
